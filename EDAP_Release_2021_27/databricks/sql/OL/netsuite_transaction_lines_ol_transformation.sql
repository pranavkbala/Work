...
**  03      02/02/2022  Godavari(JAHMED1@WSGC.COM)    21.27 Remapping
******************************************************************
...
cast(-1 as bigint) AS PACK_ITEM_KEY,
...
CAST(STG.AMOUNT AS DECIMAL(15,2)) AS EXTENDED_AMT,
CAST(STG.DISCOUNT_AMOUNT AS DECIMAL(15,2)) AS EXTENDED_DISCOUNT_AMT,
CAST(STG.NET_AMOUNT AS DECIMAL(15,2)) AS LINE_TOTAL_AMT,
...
WHERE
      ...
      OR COALESCE(STG1.EXTENDED_AMT, 0.00) <> COALESCE(T.EXTENDED_AMT, 0.00)
...
CREATE OR REPLACE TEMPORARY VIEW OL_STG1_VIEW3 AS (
  SELECT
    CASE WHEN ORDER_LINE_KEY = -1 THEN
             dense_rank() OVER (ORDER BY ORDER_LINE_KEY, ORDER_LINE_ID) + COALESCE(MAX_ORDER_LINE_KEY, 0) 
        ELSE ORDER_LINE_KEY
...
, ORDER_ITEM_TYPE_CD
, ORDER_ITEM_NAME
, NULL AS  SELL_ITEM_KEY         /* Added as part of HINATUAN Changes */    
, NULL AS SELL_ITEM_ID              /* Added as part of HINATUAN Changes */
, NULL AS  ORIGINAL_ITEM_KEY         /* Added as part of HINATUAN Changes */
, NULL AS ORIGINAL_ITEM_ID          /* Added as part of HINATUAN Changes */
, NULL AS BUNDLE_ORDER_LINE_ITEM_KEY  /* Added as part of HINATUAN Changes */
, NULL AS BUNDLE_ORDER_LINE_ITEM_ID 	/* Added as part of HINATUAN Changes */
...
, GLOBAL_FULFILLMENT_STATUS_KEY
, GLOBAL_FULFILLMENT_STATUS_CD
, NULL AS  IMPORT_DESC		 /* Added as part of HINATUAN Changes */
, PACK_ITEM_KEY
, PACK_ITEM_ID
, NULL AS   MEDIA_KEY  /* Added as part of HINATUAN Changes */
, NULL AS  MEDIA_ID  /* Added as part of HINATUAN Changes */
, FIRST_EFFECTIVE_TS
, LAST_EFFECTIVE_TS
, NULL AS UPC_CD
, NULL AS KIT_CD
...
, NULL AS LINE_MERCH_DISC_AMT   /* Added as part of HINATUAN Changes */
, NULL AS CNCLD_DEST_SURCHARGE_TAX_AMT /* Added as part of HINATUAN Changes */
, NULL AS CNCLD_GIFT_WRAP_TAX_AMT      /* Added as part of HINATUAN Changes */
 , NULL AS   CNCLD_LINE_DEST_SURCHARGE_EFF_AMT  /* Added as part of HINATUAN Changes */
, NULL AS CNCLD_LINE_GIFT_WRAP_EFF_AMT /* Added as part of HINATUAN Changes */
, NULL AS CNCLD_LINE_MERCH_EFF_AMT     /* Added as part of HINATUAN Changes */
, NULL AS CNCLD_LINE_MONO_PZ_EFF_AMT   /* Added as part of HINATUAN Changes */
, NULL AS CNCLD_LINE_SHIPPING_EFF_AMT  /* Added as part of HINATUAN Changes */
, NULL AS CNCLD_LINE_SURCHARGE_EFF_AMT /* Added as part of HINATUAN Changes */
, NULL AS CNCLD_LINE_MERCH_TAX_AMT     /* Added as part of HINATUAN Changes */
, NULL AS CNCLD_LINE_MONO_PZ_TAX_AMT   /* Added as part of HINATUAN Changes */
, NULL AS CNCLD_SHIPPING_TAX_AMT       /* Added as part of HINATUAN Changes */
, NULL AS CNCLD_SURCHARGE_TAX_AMT      /* Added as part of HINATUAN Changes */
, NULL AS DEST_SURCHARGE_TAX_AMT       /* Added as part of HINATUAN Changes */
, NULL AS GIFT_WRAP_TAX_AMT     /* Added as part of HINATUAN Changes */
, NULL AS LINE_DEST_SURCHARGE_EFF_AMT  /* Added as part of HINATUAN Changes */
, NULL AS LINE_SURCHARGE_EFF_AMT       /* Added as part of HINATUAN Changes */
, NULL AS MERCH_TAX_AMT         /* Added as part of HINATUAN Changes */
, NULL AS MONO_PZ_TAX_AMT       /* Added as part of HINATUAN Changes */
, NULL AS SHIPPING_TAX_AMT      /* Added as part of HINATUAN Changes */
, NULL AS SURCHARGE_TAX_AMT     /* Added as part of HINATUAN Changes */
...
, NULL AS CUSTOMER_ORDER_NBR /* Added as part of HINATUAN Changes */
...
, NULL AS CARRIER_CD
, NULL AS VENDOR_PACK_SIZE		/* Added as part of HINATUAN Changes */
, NULL AS HTS_CD    /* Added as part of HINATUAN Changes */	
, NULL AS INNER_PACK_SIZE			/* Added as part of HINATUAN Changes */	
...
, NULL AS RETURN_POLICY_ERROR   /* Added as part of HINATUAN Changes */
...
, NULL AS VAS_PZ_FLAG
, NULL AS VAS_RECIPE_FLAG    /* Added as part of HINATUAN Changes */
, NULL AS VAS_CARE_CARD_FLAG       /* Added as part of HINATUAN Changes*/
, NULL AS BO_NOTIFICATION_NBR
, NULL AS BO_NOTIFICATION_TYPE_CD
, NULL AS SOURCE_CREATE_TS  /* Added as part of HINATUAN Changes */
, INSERT_TS
, UPDATE_TS 
from OL_STG1_VIEW3
);
...
*/
 ...
 USING (
   ...
   INSERT
    ...
    ORDER_ITEM_TYPE_CD,
    ORDER_ITEM_NAME,
	SELL_ITEM_KEY,         /* Added as part of HINATUAN Changes */    
	SELL_ITEM_ID   ,           /* Added as part of HINATUAN Changes */
	ORIGINAL_ITEM_KEY ,        /* Added as part of HINATUAN Changes */
	ORIGINAL_ITEM_ID ,         /* Added as part of HINATUAN Changes */
	BUNDLE_ORDER_LINE_ITEM_KEY , /* Added as part of HINATUAN Changes */
	BUNDLE_ORDER_LINE_ITEM_ID, 	/* Added as part of HINATUAN Changes */
    GIFT_REGISTRY_KEY,
    GIFT_REGISTRY_ID,
    GLOBAL_SUBSIDIARY_KEY,
    GLOBAL_SUBSIDIARY_ID, 
    ...
    GLOBAL_FULFILLMENT_STATUS_KEY,
    GLOBAL_FULFILLMENT_STATUS_CD,
	IMPORT_DESC,	 /* Added as part of HINATUAN Changes */
    PACK_ITEM_KEY,
    PACK_ITEM_ID,
	MEDIA_KEY,  /* Added as part of HINATUAN Changes */
	MEDIA_ID,  /* Added as part of HINATUAN Changes */	
    FIRST_EFFECTIVE_TS,
    LAST_EFFECTIVE_TS,
    UPC_CD,
    KIT_CD,
    ...
    DONATION_AMT,
	 LINE_MERCH_DISC_AMT,   /* Added as part of HINATUAN Changes */
    CNCLD_DEST_SURCHARGE_TAX_AMT, /* Added as part of HINATUAN Changes */
    CNCLD_GIFT_WRAP_TAX_AMT ,     /* Added as part of HINATUAN Changes */
    CNCLD_LINE_DEST_SURCHARGE_EFF_AMT,  /* Added as part of HINATUAN Changes */
    CNCLD_LINE_GIFT_WRAP_EFF_AMT, /* Added as part of HINATUAN Changes */
    CNCLD_LINE_MERCH_EFF_AMT ,    /* Added as part of HINATUAN Changes */
    CNCLD_LINE_MONO_PZ_EFF_AMT,   /* Added as part of HINATUAN Changes */
    CNCLD_LINE_SHIPPING_EFF_AMT,  /* Added as part of HINATUAN Changes */
    CNCLD_LINE_SURCHARGE_EFF_AMT, /* Added as part of HINATUAN Changes */
    CNCLD_LINE_MERCH_TAX_AMT,     /* Added as part of HINATUAN Changes */
    CNCLD_LINE_MONO_PZ_TAX_AMT,   /* Added as part of HINATUAN Changes */
    CNCLD_SHIPPING_TAX_AMT,       /* Added as part of HINATUAN Changes */
    CNCLD_SURCHARGE_TAX_AMT,      /* Added as part of HINATUAN Changes */
    DEST_SURCHARGE_TAX_AMT,       /* Added as part of HINATUAN Changes */
    GIFT_WRAP_TAX_AMT,     /* Added as part of HINATUAN Changes */
    LINE_DEST_SURCHARGE_EFF_AMT,  /* Added as part of HINATUAN Changes */
    LINE_SURCHARGE_EFF_AMT,       /* Added as part of HINATUAN Changes */
    MERCH_TAX_AMT ,        /* Added as part of HINATUAN Changes */
    MONO_PZ_TAX_AMT,       /* Added as part of HINATUAN Changes */
    SHIPPING_TAX_AMT,      /* Added as part of HINATUAN Changes */
    SURCHARGE_TAX_AMT ,    /* Added as part of HINATUAN Changes */
    ASSOCIATE_ID,
    ENTRY_METHOD,
    GIFT_MESSAGE,
    VOID_FLAG,
    ...
    SHIP_TO_PHONE_NBR,
	CUSTOMER_ORDER_NBR, /* Added as part of HINATUAN Changes */
    DELIVERY_METHOD,
    FULFILLMENT_TYPE,
    DTC_SUBORDER_NBR,
    ...
    CARRIER_SERVICE_CD,
    CARRIER_CD,
	VENDOR_PACK_SIZE,		/* Added as part of HINATUAN Changes */
	HTS_CD ,   /* Added as part of HINATUAN Changes */	
	INNER_PACK_SIZE,			/* Added as part of HINATUAN Changes */	
    ACCESS_POINT_CD,
    ACCESS_POINT_ID,
    ACCESS_POINT_NM,
    MINIMUM_SHIP_DT,
	...
	RETURN_POLICY_ERROR,   /* Added as part of HINATUAN Changes */
    ...
    VAS_MONO_FLAG,
    VAS_PZ_FLAG,
	VAS_RECIPE_FLAG,    /* Added as part of HINATUAN Changes */
	VAS_CARE_CARD_FLAG,       /* Added as part of HINATUAN Changes*/
    BO_NOTIFICATION_NBR,
    BO_NOTIFICATION_TYPE_CD,
	SOURCE_CREATE_TS, /* Added as part of HINATUAN Changes */
    INSERT_TS,
    UPDATE_TS)
    VALUES
    (STG2.ORDER_LINE_KEY,
	...
	STG2.SELL_ITEM_KEY ,			/* Added as part of HINATUAN Changes */
    STG2.SELL_ITEM_ID  , 			/* Added as part of HINATUAN Changes */
    STG2.ORIGINAL_ITEM_KEY  ,			 /* Added as part of HINATUAN Changes */
    STG2.ORIGINAL_ITEM_ID ,		/* Added as part of HINATUAN Changes */
    STG2.BUNDLE_ORDER_LINE_ITEM_KEY  , 		/* Added as part of HINATUAN Changes */
    STG2.BUNDLE_ORDER_LINE_ITEM_ID , 	/* Added as part of HINATUAN Changes */
	...
	STG2.IMPORT_DESC,	 /* Added as part of HINATUAN Changes */
    STG2.PACK_ITEM_KEY,
    STG2.PACK_ITEM_ID,	
	STG2.MEDIA_KEY,  /* Added as part of HINATUAN Changes */
    STG2.MEDIA_ID,  /* Added as part of HINATUAN Changes */	
    ...
    STG2.DONATION_AMT,
	 STG2.LINE_MERCH_DISC_AMT,   /* Added as part of HINATUAN Changes */
    STG2.CNCLD_DEST_SURCHARGE_TAX_AMT, /* Added as part of HINATUAN Changes */
    STG2.CNCLD_GIFT_WRAP_TAX_AMT,      /* Added as part of HINATUAN Changes */
    STG2.CNCLD_LINE_DEST_SURCHARGE_EFF_AMT,  /* Added as part of HINATUAN Changes */
    STG2.CNCLD_LINE_GIFT_WRAP_EFF_AMT, /* Added as part of HINATUAN Changes */
    STG2.CNCLD_LINE_MERCH_EFF_AMT,     /* Added as part of HINATUAN Changes */
    STG2.CNCLD_LINE_MONO_PZ_EFF_AMT,   /* Added as part of HINATUAN Changes */
    STG2.CNCLD_LINE_SHIPPING_EFF_AMT,  /* Added as part of HINATUAN Changes */
    STG2.CNCLD_LINE_SURCHARGE_EFF_AMT, /* Added as part of HINATUAN Changes */
    STG2.CNCLD_LINE_MERCH_TAX_AMT,     /* Added as part of HINATUAN Changes */
    STG2.CNCLD_LINE_MONO_PZ_TAX_AMT,   /* Added as part of HINATUAN Changes */
    STG2.CNCLD_SHIPPING_TAX_AMT,       /* Added as part of HINATUAN Changes */
    STG2.CNCLD_SURCHARGE_TAX_AMT,      /* Added as part of HINATUAN Changes */
    STG2.DEST_SURCHARGE_TAX_AMT,       /* Added as part of HINATUAN Changes */
    STG2.GIFT_WRAP_TAX_AMT ,    /* Added as part of HINATUAN Changes */
    STG2.LINE_DEST_SURCHARGE_EFF_AMT,  /* Added as part of HINATUAN Changes */
    STG2.LINE_SURCHARGE_EFF_AMT,       /* Added as part of HINATUAN Changes */
    STG2.MERCH_TAX_AMT,         /* Added as part of HINATUAN Changes */
    STG2.MONO_PZ_TAX_AMT,       /* Added as part of HINATUAN Changes */
    STG2.SHIPPING_TAX_AMT,      /* Added as part of HINATUAN Changes */
    STG2.SURCHARGE_TAX_AMT,     /* Added as part of HINATUAN Changes */
    STG2.ASSOCIATE_ID,
    STG2.ENTRY_METHOD,
    STG2.GIFT_MESSAGE,
    STG2.VOID_FLAG,
	...
	STG2.CUSTOMER_ORDER_NBR, /* Added as part of HINATUAN Changes */
    ...
    STG2.CARRIER_CD,
	STG2.VENDOR_PACK_SIZE,		/* Added as part of HINATUAN Changes */
    STG2.HTS_CD,    /* Added as part of HINATUAN Changes */
    STG2.INNER_PACK_SIZE,		/* Added as part of HINATUAN Changes */
	...
	STG2.RETURN_POLICY_ERROR,   /* Added as part of HINATUAN Changes */
    ...
    STG2.VAS_MONO_FLAG,
    STG2.VAS_PZ_FLAG,
	STG2.VAS_RECIPE_FLAG,    /* Added as part of HINATUAN Changes */
	STG2.VAS_CARE_CARD_FLAG,       /* Added as part of HINATUAN Changes*/
    STG2.BO_NOTIFICATION_NBR,
    STG2.BO_NOTIFICATION_TYPE_CD,
	STG2.SOURCE_CREATE_TS,  /* Added as part of HINATUAN Changes */
    STG2.INSERT_TS,
    STG2.UPDATE_TS);
...
UNCACHE TABLE OL_STG_VIEW1;

UNCACHE TABLE OL_STG1_VIEW2;

UNCACHE TABLE OL_STG1_VIEW3;

UNCACHE TABLE OL_BACKFILL
