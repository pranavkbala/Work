MERGE INTO L2_ANALYTICS_TABLES.GLOBAL_PO_LINK TARGET
 USING (
    SELECT 
    STG.GLOBAL_PO_LINK_KEY as MERGE_KEY, STG.*
    FROM
         L2_STAGE.GLOBAL_PO_LINK_STG STG
    UNION
    SELECT 
    NULL as MERGE_KEY, STG1.*
        FROM 
        L2_STAGE.GLOBAL_PO_LINK_STG STG1) STG2 ON TARGET.GLOBAL_PO_LINK_KEY = STG2.MERGE_KEY
