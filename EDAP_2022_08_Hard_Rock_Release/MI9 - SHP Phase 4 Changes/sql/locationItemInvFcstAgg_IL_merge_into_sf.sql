MERGE INTO "PROD_EDAP_ANALYTICS_DB"."PROD_EDAP_ANALYTICS_TABLES"."LOCATION_ITEM_INV_FCST_WEEK_AGG" TARGET 
 USING ( 
     SELECT STG.LOCATION_ITEM_INV_FCST_WEEK_AGG_KEY AS MERGE_KEY, STG.*
     FROM "PROD_EDAP_STAGE_DB"."PROD_EDAP_STAGE_TABLES"."LOCATION_ITEM_INV_FCST_WEEK_AGG_STAGE" STG
     UNION 
     SELECT NULL AS MERGE_KEY, STG1.*
     FROM "PROD_EDAP_STAGE_DB"."PROD_EDAP_STAGE_TABLES"."LOCATION_ITEM_INV_FCST_WEEK_AGG_STAGE" STG1
    ) STG2 ON TARGET.LOCATION_ITEM_INV_FCST_WEEK_AGG_KEY = STG2.MERGE_KEY
