...
--SQL
--dbfs:/FileStore/tables/sql/order/dtc/bosts/insert_open_orders_agg_snoflk.sql

-- COMMAND ----------

-- DBTITLE 1,MOVE SQL & Backup(change sql script. Wrong here)
-- MAGIC %python
-- MAGIC dbutils.fs.mv("dbfs:/FileStore/tables/sql/order/dtc/bosts/insert_open_orders_agg_snoflk.sql","dbfs:/FileStore/tables/sql/order/dtc/bosts/insert_open_orders_agg_snoflk_eda2201_20220214bkp.sql")
...
CREATE TABLE "PROD_EDAP_ANALYTICS_DB"."PROD_EDAP_ANALYTICS_TABLES"."OPEN_ORDERS_AGG_20220214" CLONE "PROD_EDAP_ANALYTICS_DB"."PROD_EDAP_ANALYTICS_TABLES"."OPEN_ORDERS_AGG";

select count(*) from "PROD_EDAP_ANALYTICS_DB"."PROD_EDAP_ANALYTICS_TABLES"."OPEN_ORDERS_AGG_20220214"
