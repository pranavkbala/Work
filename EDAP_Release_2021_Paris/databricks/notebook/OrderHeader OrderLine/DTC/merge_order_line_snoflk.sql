MERGE INTO "PROD_EDAP_ANALYTICS_DB"."PROD_EDAP_ANALYTICS_TABLES"."ORDER_LINE" tgt
 USING "PROD_EDAP_STAGE_DB"."PROD_EDAP_STAGE_TABLES"."ORDER_LINE_STAGE" stg
	ON tgt.source_system = 'STERLING_DTC'  
	and tgt.ORDER_dt = stg.ORDER_dt  
	and trim(tgt.ORDER_LINE_ID) = trim(stg.ORDER_LINE_ID) 
	and tgt.FIRST_EFFECTIVE_TS = stg.FIRST_EFFECTIVE_TS 
 WHEN MATCHED  AND tgt.LAST_EFFECTIVE_TS != stg.LAST_EFFECTIVE_TS THEN
	UPDATE  
