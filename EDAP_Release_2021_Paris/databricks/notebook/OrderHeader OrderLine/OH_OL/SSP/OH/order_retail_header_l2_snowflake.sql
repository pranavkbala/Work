...
** Source Table   : "PROD_EDAP_STAGE_DB"."PROD_EDAP_STAGE_TABLES"."ORDER_RTL_HEADER_STG"
** Target Table   : "PROD_EDAP_ANALYTICS_DB"."PROD_EDAP_ANALYTICS_TABLES"."ORDER_HEADER"
** Lookup         :

** Transformations  : Merge data from ORDER_RTL_HEADER_STG to Order-Header in SnowFlake
...
**  04      07/23/2021  SUT-160   Addition of columns

******************************************************************
*/


MERGE INTO "PROD_EDAP_ANALYTICS_DB"."PROD_EDAP_ANALYTICS_TABLES"."ORDER_HEADER"   HEADER USING 
(  
	SELECT STG_1.ORDER_HEADER_KEY AS MERGE_KEY, STG_1.* FROM "PROD_EDAP_STAGE_DB"."PROD_EDAP_STAGE_TABLES"."ORDER_RTL_HEADER_STG" STG_1 
	UNION   
	SELECT NULL AS MERGE_KEY, STG_2.* FROM  "PROD_EDAP_STAGE_DB"."PROD_EDAP_STAGE_TABLES"."ORDER_RTL_HEADER_STG" STG_2 
) STG    
...
WHEN MATCHED AND HEADER.LAST_EFFECTIVE_TS = '9999-12-31 23:59:59.000+0000' THEN 
	UPDATE SET   
