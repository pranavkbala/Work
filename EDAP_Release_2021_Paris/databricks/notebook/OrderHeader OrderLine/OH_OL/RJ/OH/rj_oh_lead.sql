...
**  --      ----------  --------  --------------------------------
**  01      03/09/2021  DAN-5288  SQL file created
...
** Purpose      	: Historical Data Ingestion using Lead function on TXN_END_TS
...
SELECT
         ...
         STG.FIRST_EFFECTIVE_TS,
	       COALESCE(LEAD(STG.MODIFIED_TS) OVER (PARTITION BY STG.ORDER_HEADER_ID, STG.ORDER_DT ORDER BY STG.MODIFIED_TS),STG.LAST_EFFECTIVE_TS) AS LAST_EFFECTIVE_TS,
