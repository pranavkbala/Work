...
Source : L2_STAGE.RJ_ORDER_LINE_STG
Target : L2_ANALYTICS_TABLES.ORDER_LINE
...
*/
      ...
      MERGE INTO L2_ANALYTICS_TABLES.ORDER_LINE TARGET USING
        (
          SELECT STG_1.ORDER_LINE_KEY AS MERGE_KEY, STG_1.* FROM L2_STAGE.RJ_ORDER_LINE_STG STG_1
          UNION
          SELECT NULL AS MERGE_KEY, STG_2.* FROM L2_STAGE.RJ_ORDER_LINE_STG STG_2
