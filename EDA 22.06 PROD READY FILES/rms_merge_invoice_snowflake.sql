MERGE INTO "PROD_EDAP_ANALYTICS_DB"."PROD_EDAP_ANALYTICS_TABLES"."INVOICE" TARGET USING
        (
       	 SELECT STG1_1.INVOICE_KEY AS MERGE_KEY, STG1_1.* FROM "PROD_EDAP_STAGE_DB"."PROD_EDAP_STAGE_TABLES"."INVOICE_RMS_STAGE" STG1_1
       	 UNION
       	 SELECT NULL AS MERGE_KEY, STG1_2.* FROM "PROD_EDAP_STAGE_DB"."PROD_EDAP_STAGE_TABLES"."INVOICE_RMS_STAGE" STG1_2
         ...
         WHEN NOT MATCHED AND MERGE_KEY IS NULL THEN
			...
			TRY_TO_DECIMAL(STG1.DTC_COLLECTED_AMT,15,2),
       	    STG1.TOTAL_QTY,
       	    STG1.TOTAL_AMT,
			NULL,                      /* HINATUAN */
			STG1.CURRENCY_CD,
