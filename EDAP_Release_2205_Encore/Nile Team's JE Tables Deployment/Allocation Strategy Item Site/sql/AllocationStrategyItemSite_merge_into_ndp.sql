MERGE INTO L2_ANALYTICS_TABLES.INV_FCST_LOCATION_ITEM_ALLOC_STRATEGY TARGET
 USING (
    SELECT STG.INV_FCST_LOCATION_ITEM_ALLOC_STRATEGY_KEY as MERGE_KEY, STG.*
    FROM L2_STAGE.INV_FCST_LOCATION_ITEM_ALLOC_STRATEGY_STG STG
    UNION
    SELECT NULL as MERGE_KEY, STG1.*
    FROM L2_STAGE.INV_FCST_LOCATION_ITEM_ALLOC_STRATEGY_STG STG1
    ) STG2 
    ON TARGET.INV_FCST_LOCATION_ITEM_ALLOC_STRATEGY_KEY = STG2.MERGE_KEY
