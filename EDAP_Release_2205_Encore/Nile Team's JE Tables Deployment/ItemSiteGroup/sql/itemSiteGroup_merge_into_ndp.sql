MERGE INTO L2_ANALYTICS_TABLES.INV_FCST_LOCATION_ITEM_GROUP TARGET
 USING (
    SELECT STG.INV_FCST_LOCATION_ITEM_GROUP_KEY as MERGE_KEY, STG.*
    FROM L2_STAGE.INV_FCST_LOCATION_ITEM_GROUP_STG STG
    UNION
    SELECT NULL as MERGE_KEY, STG1.*
    FROM L2_STAGE.INV_FCST_LOCATION_ITEM_GROUP_STG STG1
    ) STG2 
    ON TARGET.INV_FCST_LOCATION_ITEM_GROUP_KEY = STG2.MERGE_KEY
